...
const MemeChatGroupTest: React.FC = () => {
  return (
    <div style={{ 
      maxWidth: '1200px', 
      margin: '0 auto', 
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          A group chat implementation inspired by MemeChat with modern React
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <p>
          This is a group chat implementation inspired by the MemeChat example. 
...
export default MemeChatGroupTest;